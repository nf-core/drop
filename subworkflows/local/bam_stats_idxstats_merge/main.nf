...
workflow BAM_STATS_IDXSTATS_MERGE {
    ...
    def ch_merged_bam_stats = SAMTOOLS_IDXSTATS.out.idxstats
        ...
        .collectFile(name: "merged_bam_stats.tsv", newLine:true, sort:false, storeDir:"${params.outdir}/aberrant_expression/bam_stats/") // TODO this should be another name + add storeDir with the output dir location
        .collect()
